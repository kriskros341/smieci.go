...
const _postMarkerSolution = async (axios: AxiosInstance, markerId: string, payload: SolveMarkerEditorFormValues) => {
  ...
  formData.append('payload', JSON.stringify({ participants: payload.participants }));
  return axios.post(`/markers/${markerId}/solve`, formData, { headers: { "Content-Type": "multipart/form-data" }, } ).catch((e) => console.warn("blad", JSON.stringify(e, undefined, 2)));
}
...
const useSolveMarkerMutation = (markerId: string, options: useSolveMarkerMutationOptions) => {
